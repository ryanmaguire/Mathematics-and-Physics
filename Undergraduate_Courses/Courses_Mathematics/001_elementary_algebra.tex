    ...
    \section{North Shore Placement Exam}
        \subsection{Order of Operations}
            ...
            \begin{properties}[Arithmetic Properties]
                ...
                \begin{enumerate}
                    ...
                    \item%
                        ...
                        $a\cdot(b\cdot c)=(a\cdot b)\cdot c$\hfill%
                    ...
                    \item
                        ...
                        $a\cdot (b+c)=a\cdot b+a\cdot c$\hfill%
            ...
            \begin{example}
                \
                \begin{enumerate}
                    \item $2\cdot 3+4\cdot%
                        5\overset{\textrm{\tiny{M}}}{=}%
                        6+20\overset{\textrm{\tiny{A}}}{=}26$
                    \item $2\cdot 3+4\overset{\textrm{\tiny{M}}}{=}%
                        6+4\overset{\textrm{\tiny{A}}}{=}\boxed{10}$
                    \item $3\cdot 3+2^{4}%
                        \overset{\textrm{\tiny{E}}}{=}%
                        3\cdot 3+16\overset{\textrm{\tiny{M}}}{=}%
                        9+16\overset{\textrm{\tiny{A}}}{=}\boxed{25}$
                    ...
                    \item $(1+1)^{(2+3)}\cdot 5-2\cdot%
                        3\overset{\textrm{\tiny{P}}}{=}2^{5}%
                        \cdot 5-2\cdot%
                        3\overset{\textrm{\tiny{E}}}{=}%
                        32\cdot 5-2\cdot%
                        3\overset{\textrm{\tiny{M}}}{=}%
                        160-6\overset{\textrm{\tiny{S}}}{=}%
                        \boxed{154}$
                    \item $(2+2)-(16-11)^{(1+1)}%
                        \overset{\textrm{\tiny{P}}}{=}4-5^{2}%
                        \overset{\textrm{\tiny{E}}}{=}4-25%
                        \overset{\textrm{\tiny{S}}}{=}\boxed{-21}$
                \end{enumerate}
            \end{example}
            \begin{remark}
                \label{remark:North_Shore_Radicals_Def}
                Many problems involve radicals. These are defined by
            ...
            \begin{theorem}
                ...
                If $x$ is \textbf{positive}, and $i$ is the imaginary
                unit $(i^{2}=-1)$, then $\sqrt{-x}=i\sqrt{x}$
            \end{theorem}
            \begin{example}
                \
                \begin{enumerate}
            ...
            \begin{theorem}
                ...
                If $n$ is an \textbf{odd} integer, and $x$ is a
                \textbf{real} number, then
                $\sqrt[n]{-x}=-\sqrt[n]{x}$
            \end{theorem}
            \begin{example}
                \
            ...
            \begin{remark}
                ...
                For all non-zero  real numbers, $x^{0}=1$. $0^0$
                is left undefined.
            \end{remark}
            \begin{example}
                \
            ...
            \begin{proof}[Solution]
                \begin{flalign*}
                    9\div 3\cdot 5-8\div 2+27&=3\cdot 5-4+27
                    &\tag{%
            ...
            \begin{proof}[Solution]
                \begin{flalign*}
                    ...
                    \tag{%
                        Def.~\ref{%
                            definiiton:North_Shore_Absolute_%
                            Value_Def%
                        }%
                    }\\
            ...
            \begin{proof}[Solution]
                \begin{flalign*}
                    ...
                    &\tag{%
                        Remark~\ref{%
                            remark:North_Shore_Rational_Expressions%
                        }%
                    }\\
        ...
        \subsection{Scientific Notation}
            ...
            $r\times 10^{n}$, where $1\leq |r|<10$ and $n$
            is an integer.
            \begin{example}
                \
                \begin{enumerate}
        ...
        \subsection{Substitution}
            ...
            \begin{proof}[Solution]
                \begin{flalign*}
                    ...
                    &=\tfrac{5(3)-(2)}{(3)(-4)}&\tag{Substitution}\\
