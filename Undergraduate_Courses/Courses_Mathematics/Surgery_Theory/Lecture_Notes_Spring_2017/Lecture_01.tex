...
\begin{document}
    ...
    \subsection{Lecture 1: Homotopy}
        ...
        homeomorphism preserve dimension. We use the fact that
        ...
        structure set of $Y$. This set contains maps
        like $f_{1}$, $f_{2}$.
        ...
        \subsubsection{Exact Sequences and Surgery Exact Sequences}
            ...
            \begin{example}
                ...
                $\Im(f)=0$, $\ker(g)=0$. So $g$ is injective.
            \end{example}
            \begin{example}
            ...
            \begin{definition}
                ...
                $0\overset{f}{\rightarrow}%
                 ...
                 L\overset{f_{3}}{\rightarrow}0$
            \end{definition}
            We have, from the previous examples,
            than in an exact sequence $f$ must be
