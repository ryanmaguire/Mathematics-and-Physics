    ...
    \subsection{Lecture 1: Homotopy}
        ...
        \begin{wrapfigure}[8]{r}{0.32\textwidth}
            ...
            \begin{tikzpicture}[%
                ...
                % Draw upper curve.
                \draw (a0) to
                    [quick curve through={(b0)..(c0)..(d0)}] (e0);

                % Draw lower curve.
                \draw (a1) to
                    [quick curve through={(b1)..(c1)..(d1)}] (e1);
        ...
        \end{theorem}
        The amazing fact about Thm.~\ref{%
            theorem:surgery_theory_finite_%
            product_of_compact_is_compact%
        } is that the finiteness of the product is
        ...
        \begin{figure}[H]
            ...
            \begin{subfigure}[b]{0.66\textwidth}
                ...
                \begin{tikzpicture}[%
                    ...
                    \draw[thick, <->] (-1.5,0) -- (1.5,0);
                    \draw[thick, <->] (0,-1.5) -- (0,1.5);
                    \draw[grayarrow](1.1,1.1)--(0.75,0.75);
                    \draw[grayarrow](-1.1,-1.1)--(-0.75,-0.75);
                    \draw[grayarrow](1.1,-1.1)--(0.75,-0.75);
                    \draw[grayarrow](-1.1,1.1)--(-0.75,0.75);
                    \draw[grayarrow](0.2,0.2)--(0.6,0.6);
                    \draw[grayarrow](-0.2,-0.2)--(-0.6,-0.6);
                    \draw[grayarrow](0.2,-0.2)--(0.6,-0.6);
                    \draw[grayarrow](-0.2,0.2)--(-0.6,0.6);
        ...
        \begin{figure}[H]
            ...
            \begin{tikzpicture}[scale=5, >=triangle 45]
                ...
                \node[circle, inner sep=0pt, outer sep=1mm]
                    (B) at 
                    (1.3660254,0,1.3660254) {};
                \draw[draw=blue,semithick] (0,1,0) -- (A);
                \draw[dashed]
                    (0,0,0)--(1.3660254,0,1.3660254);
                ...
                \draw[dashed, thin]
                    ...
                    (1.3660254,0,1.3660254);
                \draw[dashed,thin]
                    (1.3660254,0,0)--(1.3660254,0,1.3660254);
                \draw[dashed,semithick]
                    (0,0,0)--
                    (0.57735,0.57735,0.57735);
                \draw[dashed,thin]
                    (0,0,0.57735)--(0.57735,0,0.57735);
                \draw[dashed,thin]
                    (0.57735,0,0)--(0.57735,0,0.57735);
                \draw[dashed,thin]
                    (0.57735,0,0.57735)--(0.57735,0.57735,0.57735);
                \draw[dashed,thin]
                    (0,0,0.57735)--(0.57735,0,0.57735);
                \filldraw[black]
                    (0.57735,0.57735,0.57735) circle (0.2mm);
                \filldraw[red]
                    (1.3660254,0,1.3660254) circle (0.2mm);
        ...
        \begin{figure}[H]
            ...
            \begin{tikzpicture}[%
                ...
                \draw[ball color=gray!60!white,shading angle=250]
