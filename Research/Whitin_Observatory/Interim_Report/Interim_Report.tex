...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.43\textwidth}
        \includegraphics[
            width=\textwidth,
            page=1,
            trim={0.55in 0.5in 0.0in 0.5in},
            clip
        ]{user_guide_fig_3-10_a_rotated.pdf}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        \includegraphics[
            width=\textwidth,
            page=1,
            trim={1in 0.65in 0in 0in},
            clip
        ]{RSS_User_Guide_Fig_3-11_22JAN2018.pdf}
        \caption{Our calculation}
        \label{fig:fig3-11}
    \end{subfigure}
