...
\begin{document}
    ...
    \begin{frame}{The Cassini Mission}
        \begin{figure}
            \resizebox{\textwidth}{!}{\includegraphics{cassini_huygens}}
        \end{figure}
    \end{frame}
    \begin{frame}{The Cassini Mission}
    ...
    \begin{frame}{The Cassini Mission}
        \begin{figure}
            \resizebox{!}{0.9\textheight}{\includegraphics{cassini_being_built}}
        \end{figure}
    \end{frame}
    \begin{frame}{The Cassini Mission}
    ...
    \begin{frame}{The Cassini Mission}
        \begin{figure}
            \resizebox{\textwidth}{!}{\includegraphics{cassini_trajectory}}
        \end{figure}
    \end{frame}
    \begin{frame}{The Cassini Mission}
        Cassini saw the moon...
        \begin{figure}
            \resizebox{!}{0.7\textheight}{\includegraphics{moon_from_cassini}}
        \end{figure}
    \end{frame}
    \begin{frame}{The Cassini Mission}
        Cassini saw Jupiter...
        \begin{figure}
            \resizebox{!}{0.7\textheight}{\includegraphics{jupiter_from_cassini}}
        \end{figure}
    \end{frame}
    \begin{frame}{The Cassini Mission}
        Before finally arriving at Saturn.
        \begin{figure}
            \resizebox{\textwidth}{!}{\includegraphics{sun_behind_saturn}}
        \end{figure}
    \end{frame}
    \begin{frame}{The Cassini Mission}
        And with Cassini's arrival came a plethora of new discoveries.
        \begin{figure}
            \resizebox{!}{0.8\textheight}{\includegraphics{rings_of_saturn}}
        \end{figure}
    \end{frame}
    \begin{frame}{The Cassini Mission}
    ...
    \begin{frame}{The Fresnel Approximation}
        \begin{figure}
            \resizebox{\textwidth}{!}{\includegraphics{voyager_ring_6_diffracted_power}}
        \end{figure}
    \end{frame}
    \begin{frame}{The Fresnel Approximation}
        \begin{figure}
            \resizebox{\textwidth}{!}{\includegraphics{voyager_ring_6_reconstructed_power_100m}}
        \end{figure}
    \end{frame}
    \begin{frame}{The Fresnel Approximation}
        \begin{figure}
            \resizebox{\textwidth}{!}{\includegraphics{voyager_ring_6_reconstructed_power_50m}}
        \end{figure}
    \end{frame}
    \begin{frame}{The Fresnel Approximation}
    ...
    \begin{frame}{The Fresnel Approximation}
        \begin{figure}
            \resizebox{\textwidth}{!}{\includegraphics{cassini_maxwell_rev007e_diffracted_power_250m}}
        \end{figure}
    \end{frame}
    \begin{frame}{The Fresnel Approximation}
        \begin{figure}
            \resizebox{\textwidth}{!}{\includegraphics{cassini_maxwell_rev007e_reconstructed_power_1000m}}
        \end{figure}
    \end{frame}
    \begin{frame}{The Fresnel Approximation}
    ...
    \begin{frame}{The Fresnel Approximation}
        \begin{figure}
            \resizebox{\textwidth}{!}{\includegraphics{cassini_maxwell_rev007e_diffracted_power_50m}}
        \end{figure}
    \end{frame}
    \begin{frame}{The Fresnel Approximation}
        \begin{figure}
            \resizebox{\textwidth}{!}{\includegraphics{cassini_maxwell_rev007e_reconstructed_power_100m}}
        \end{figure}
    \end{frame}
    ...
    \begin{frame}{High Resolution with Low Opening Angle}
        ...
        \begin{figure}
            \resizebox{\textwidth}{!}{\includegraphics{cassini_boring_part_of_the_rings_diffracted_power.jpeg}}
        \end{figure}
    \end{frame}
    \begin{frame}{High Resolution with Low Opening Angle}
        ...
        \begin{figure}
            \resizebox{\textwidth}{!}{\includegraphics{cassini_boring_part_of_the_rings_optical_depth_1000m}}
        \end{figure}
    \end{frame}
    \begin{frame}{High Resolution with Low Opening Angle}
        Here's what we can do now!
        \begin{figure}
            \resizebox{\textwidth}{!}{\includegraphics{cassini_boring_part_of_the_rings_optical_depth_50m}}
        \end{figure}
    \end{frame}
    \begin{frame}{High Resolution with Low Opening Angle}
    ...
    \begin{frame}{High Resolution with Low Opening Angle}
        I think so.
        \begin{figure}
            \resizebox{\textwidth}{!}{\includegraphics{cassini_rev133e_a_ring_model}}
        \end{figure}
    \end{frame}
    \begin{frame}{High Resolution with Low Opening Angle}
        The reconstruction.
        \begin{figure}
            \resizebox{\textwidth}{!}{\includegraphics{cassini_rev133e_a_ring_reconstruction}}
        \end{figure}
    \end{frame}
    \begin{frame}{Some Problems Ahead...}
        ...
        \begin{figure}
            \resizebox{0.8\textwidth}{!}{\includegraphics{moon_daphnis_from_cassini}}
        \end{figure}
    \end{frame}
    \begin{frame}{Some Problems Ahead...}
        ...
        parts.
        \begin{figure}
            \resizebox{0.8\textwidth}{!}{\includegraphics{saturn_f_ring}}
        \end{figure}
        There is ongoing research to try to resolve these issues.
    \end{frame}
    \begin{frame}{The End}
        \begin{center}
            Thanks!
