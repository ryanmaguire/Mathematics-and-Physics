...
\begin{document}
    ...
    \section{Peano's Curve}
        ...
        Hausdorff condition has been upgraded to metrizability. These are
        sometimes called \textit{non-metric continua}.
        \begin{example}
        ...
        \begin{definition}[Nondegenerate Topological Continuum]
            ...
            $(X,\,\tau)$ such that $\textrm{Card}(X)\geq{2}$. That is, a
        ...
        collection of points is the power set.
        \begin{example}
