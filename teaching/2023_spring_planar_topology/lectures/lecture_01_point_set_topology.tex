...
\begin{document}
    ...
    \section{Continuity}
        ...
        \subsection{Product Spaces}
            ...
            Products in topology are defined in one of two ways. The, perhaps
            more natural way, is by \textit{generating} the topology. Given
        ...
        \subsection{Homotopy and Homotopy Equivalence}
            ...
            \begin{definition}[Homotopy Inverse]
                ...
                $g:Y\rightarrow{X}$ such that $g\circ{f}$ is homotopy to
                $\textrm{id}_{X}$ and $f\circ{g}$ is homotopic to
                $\textrm{id}_{X}$.\index{Homotopy Inverse!Definition}
            \end{definition}
            \begin{definition}[Homotopy Equivalence]
                ...
                a homotopy inverse $g:Y\rightarrow{X}$ of $f$.%
                \index{Homotopy Equivalence!Definition}
            \end{definition}
            \begin{theorem}
            ...
            homotopy. The real culprit behind this fact is contractibility.
            \begin{theorem}
    ...
    \section{Compactness and Connectedness}
        ...
        \begin{theorem}[Heine-Borel Theorem]
            A subset $\mathcal{C}\subseteq\mathbb{R}^{N}$ is compact if and only
            if $\mathcal{C}$ is closed and bounded (with respect to the
            Euclidean metric).%
            \index{Theorem!Heine-Borel}
        \end{theorem}
        ...
        \par\hfill\par
        There are several notions of a space being \textit{connected}, and in
        a course on planar topology it is essential to note the differences.
        The simplest notion of connectedness uses open sets and describes how
        to \textit{disconnect} a space.\index{Topological Space!Disconnected}%
        ...
        \begin{definition}[Disconnected Topological Space]
            ...
            \index{Disconnected Topological Space!Definition}
        \end{definition}
        \begin{definition}[Connected Topological Space]
            A connected topological space is a topological space that is
            not disconnected.\index{Connected Topological Space!Definition}%
        ...
        \end{figure}
        Stronger than connectedness is the notion of \textit{path} connected.%
        \index{Path Connected Space}%
        ...
        \begin{definition}[Path Connected Topological Space]
            ...
            path $\gamma:[0,\,1]\rightarrow{X}$ such that
            $\gamma(0)=x$ and $\gamma(1)=y$.
        \end{definition}
        \begin{theorem}
            If $(X,\,\tau)$ is a path connected topological space, then it is
            connected.
        \end{theorem}
        \begin{proof}
            ...
            $\gamma^{-1}[\mathcal{U}]$ and $\gamma^{-1}[\mathcal{V}]$ are open.
            But these subsets are also disjoint and non-empty, meaning
        ...
        \end{definition}
        Every path connected Hausdorff space is arc connected. We'll be talking
        a lot about arc connected spaces when we discuss space filling curves.
