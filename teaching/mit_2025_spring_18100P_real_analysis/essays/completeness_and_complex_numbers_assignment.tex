...
\begin{document}
    ...
    \begin{itemize}
        ...
        \item
            ...
            \begin{itemize}
                ...
                \item
                    Does the paper have an introduction that identifies and
                    signals the purpose and the main result for a general
                    audience (i.e. not someone currently enrolled in 18.100P
                    or necessarily currently taking real analysis)?
                 \item
                 ...
                 \item
                    ...
                    from writing assignment 1, namely:
                    \begin{itemize}
                        \item
    ...
    \par\hfill\par
    \textbf{Rough Draft: 2026/03/13}
    \par
    A full draft of your article.
    You will receive feedback on your writing shortly after break.
    \par\hfill\par
    \textbf{Instructor Feedback: 2026/03/27}
    \par
    You will receive comments on mathematical correctness and
    communication clarity that you are expected to account for in your
    final version. Questions about comments will be handled in office hours.
    \par\hfill\par
    \textbf{Final Due: 2026/04/04}
    \par
    After making revisions based on feedback,
    you will turn in your final draft for grading.
\end{document}
