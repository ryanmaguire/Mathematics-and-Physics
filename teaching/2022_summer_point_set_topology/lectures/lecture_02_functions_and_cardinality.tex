...
\begin{document}
    ...
    \section{Functions}
        ...
        \begin{example}
            ...
            as well. Similarly as $x$ tends to negative infinity,
            so does $f(x)$. By the intermediate value theorem, $f$ hits
            every value in between, meaning $f$ is surjective. It is not
            injective since $f(0)=f(1)=0$.
        \end{example}
        ...
        \end{example}
        \begin{definition}[\textbf{Composition}]
            The composition of functions $f:A\rightarrow{B}$ and
            $g:B\rightarrow{C}$ is the function
            $g\circ{f}:A\rightarrow{C}$ defined by:
            \begin{equation}
                (g\circ{f})(a)=g\big(f(a)\big)
            \end{equation}
            That is, apply $f$ to $a$ first, and then apply $g$ to $f(a)$.
        \end{definition}
        ...
        \begin{proof}
            ...
            same function.
        \end{proof}
        This tells us inverse functions are unique. We may then adopt the
        following notation.
        \begin{notation}
            If $f:A\rightarrow{B}$ is a function with an inverse
            $g:B\rightarrow{A}$ we denote this $g=f^{-1}$.
        \end{notation}
        \begin{definition}[\textbf{Image of a Set}]
            The image of a subset $\mathcal{U}\subseteq{A}$ of a function
            $f:A\rightarrow{B}$ is the set $f[\mathcal{U}]\subseteq{B}$
            defined by:
            \begin{equation}
        ...
        \begin{definition}[\textbf{Pre-Image of a Set}]
            ...
            $f:A\rightarrow{B}$ is the set $f^{-1}[\mathcal{V}]\subseteq{A}$
            defined by:
            \begin{equation}
        ...
        \begin{example}
            ...
            $f(x)=\sin(x)$. The pre-image of the set $(0,1)$ is the set of
            all real numbers $x$ with $0<\sin(x)<1$. This is the set of real
