...
\begin{document}
    ...
    \section{Smooth Manifolds}
        The general topological spaces does not have any notion of derivative.
        We can speak of continuity, by differentiation in $\mathbb{R}^{n}$
        ...
        navigate anywhere in you space using smooth transitions.
        ...
        \begin{definition}[\textbf{Smoothable Manifold}]
            A smooth manifold is a topological manifold $(X,\,\tau)$ such that
            there exists a smooth atlas $\mathcal{A}$ for $(X,\,\tau)$.
        \end{definition}
