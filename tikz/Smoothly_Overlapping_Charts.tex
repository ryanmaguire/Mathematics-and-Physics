...
\begin{tikzpicture}[>=Latex, line width=0.2mm]
    ...
    \coordinate (X0) at (-6.0,  0.0);
    \coordinate (X1) at (-3.5, -3.0);
    \coordinate (X2) at ( 1.0, -2.5);
    ...
    \begin{scope}[xshift=-5cm, yshift=4cm]
        ...
        \draw[->] (-1.0,  0.0) to ( 4.0,  0.0);
        \draw[->] ( 0.0, -1.0) to ( 0.0,  4.0);
    ...
    \begin{scope}[line width=0.4mm]
        \draw[->]   (-2, 0.5)   to[out=130, in=-100]
                                node[left] {\large{$\phi$}} (-3.5, 4);
        \draw[->]   ( 2, 0.5)   to[out=50, in=-80]
                                node[right] {\large{$\xi$}} ( 3.5, 4);
        \draw[->]   (-1.5, 5.5) to[out=30, in=150]
            node[above] {\large{$\xi\circ\phi^{\minus{1}}$}} ( 1.5, 5.5);
        \draw[->]   ( 1.5, 4.5) to[out=-150, in=-30]
            node[below] {\large{$\phi\circ\xi^{\minus{1}}$}} (-1.5, 4.5);
    \end{scope}

    \node at (-5.0,  0.5) {$X$};
    \node at (-3.0, -1.5) {$\mathcal{U}$};
    \node at ( 3.0, -1.5) {$\mathcal{V}$};
