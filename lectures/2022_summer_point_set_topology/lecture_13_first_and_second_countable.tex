...
\begin{document}
    ...
    \section{First Countable}
        ...
        \begin{definition}[\textbf{Neighborhood Basis}]
            ...
            $x\in\mathcal{V}$, there is a $\mathcal{U}\in\mathcal{B}$ such
            that $\mathcal{U}\subseteq\mathcal{V}$.
        \end{definition}
    ...
    \section{Second Countable}
        ...
        some $n\in\mathbb{N}$. In other words, metric subspaces of Euclidean
        ...
        \begin{definition}[\textbf{Second-Countable Topological Space}]
            ...
            $(X,\,\tau)$ such that there exists a countable basis
