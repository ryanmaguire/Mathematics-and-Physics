...
\begin{document}
    ...
    \section{More on Open and Closed}
        ...
        \begin{example}
            ...
            $d(x,\,y)=|x-y|$ there are no sets that are both open and closed.
            Open sets are formed by open intervals $(a,\,b)$ and the union of
            such sets. Closed sets are the complements of these sets. Examples
            include closed intervals $[a,\,b]$ single points $\{\,x\,\}$ and
