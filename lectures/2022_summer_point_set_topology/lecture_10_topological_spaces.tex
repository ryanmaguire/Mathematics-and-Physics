...
\begin{document}
    ...
    \begin{proof}
        ...
        \begin{equation}
            \mathcal{V}=\bigcup_{k=0}^{n-1}\mathcal{U}_{k}
        \end{equation}
        is open. But then $\bigcap\mathcal{O}=\mathcal{V}\cap\mathcal{U}_{n}$,
        the intersection of two open sets, which is open. Hence,
    ...
    \begin{definition}[\textbf{Fr\'{e}chet Topological Space}]
        ...
        such that for all $x,y\in{X}$ there exists
    ...
    \end{theorem}
    \begin{proof}
        Let $x,y\in{X}$. Since $(X,\,\tau)$ is Hausdorff, there exists open
    ...
    \textit{Fr\'{e}chet-Urysohn topological space}. Fr\'{e}chet also invented
    ...
    \begin{example}[\textbf{Finite Complement Topology}]
        ...
        $\mathcal{U}$ and $\mathcal{V}$ are open since there complements contain
    ...
    \begin{example}[\textbf{Countable Complement Topology}]
        ...
        (that is, finite or countably infinite), and include the
        ...
        $\mathcal{U},\mathcal{V}\subseteq\mathbb{R}$, the intersection is
        also included since:
        \begin{equation}
            \mathbb{R}\setminus(\mathcal{U}\cup\mathcal{V})
            =(\mathbb{R}\setminus\mathcal{U})\cup
        ...
        $x\ne{y}$, we define $\mathcal{U}=\mathbb{R}\setminus\{\,x\,\}$ and
        $\mathcal{V}=\mathbb{R}\setminus\{\,y\,\}$, showing
    ...
    \begin{proof}
        ...
        $\mathcal{U},\mathcal{V}\in\bigcap{T}$, then for all $\tau\in{T}$,
        $\mathcal{U},\mathcal{V}\in\tau$. But all $\tau\in{T}$ are topologies,
        so $\mathcal{U}\cap\mathcal{V}\in\tau$ for all $\tau$, so
        ...
        $\bigcup\mathcal{O}\in\tau$. Hence, $\bigcap\mathcal{O}\in\bigcap{T}$.
