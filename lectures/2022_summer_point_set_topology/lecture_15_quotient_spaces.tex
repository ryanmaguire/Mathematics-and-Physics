...
\begin{document}
    ...
    \section{Quotient Topology}
        ...
        \begin{proof}
            ...
            is saturated, then
            $q^{-1}\big[q[\big[\mathcal{U}]\big]=\mathcal{U}$. But then
        ...
        \begin{definition}[\textbf{Quotient Map}]
            ...
            function $f:X\rightarrow{Y}$ such that for every saturated open
            set $\mathcal{U}\in\tau_{X}$ it is true that
            $f[\mathcal{U}]\in\tau_{Y}$.
        \end{definition}
        \begin{theorem}
            If $(X,\,\tau_{X})$ and $(Y,\,\tau_{Y})$ are topological spaces,
            if $f:X\rightarrow{Y}$ are quotient maps, then there is an
            equivalence relation $R$ on $X$ such that $(Y,\,\tau_{Y})$ is
            homeomorphism to $(X/R,\,\tau_{X/R})$ where $\tau_{X/R}$ is the
            quotient topology.
        \end{theorem}
        \begin{proof}
            Let $R$ be the relation on $A$ defined by $aRb$ if and only if
            ...
            $g([a])=f(a)=f(b)=q([b])$. $q$ is a homeomorphism. First, it is
            bijective. It is injective since if $g([a])=g([b])$, then
            $f(a)=f(b)$, and hence $aRb$, so $[a]=[b]$. It is surjective since
            given $y\in{Y}$, since $f$ is surjective there is $x\in{X}$ such
            that $f(x)=y$. But then $g([x])=f(x)$, so $g$ is surjective.
            Therefore, $g$ is bijective. $g$ is continuous. Given
            ...
            $q:X\rightarrow{X}/R$ is the quotient map. But $\tau_{X/R}$ is
            the quotient topology, so if
            ...
            $g[\mathcal{U}]$ is the set of all $y\in{Y}$ such that
            $y=g([x])$ for some $x\in{f}^{-1}[\mathcal{V}]$. Since
            $\mathcal{U}\in\tau_{X/R}$ and $q$ is continuous,
            $q^{-1}[\mathcal{U}]\in\tau_{X}$.
        \end{proof}
    \section{Quotient by Subspaces}
