...
\begin{document}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics{../../images/continuous_bounded_function_has_bounded_area.pdf}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics{../../images/lower_sum_of_continuous_function.pdf}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics{../../images/upper_sum_of_continuous_function.pdf}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics{../../images/integral_of_continuous_function.pdf}
