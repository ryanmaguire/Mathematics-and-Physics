...
draw(Label("$y$", pos, align=N),  O--( 3,  0), Arrow(arsize));
draw(Label("$z$", pos, align=E),  O--( 0,  3), Arrow(arsize));
draw(Label("$x$", pos, align=NW), O--(-2, -2), Arrow(arsize));
...
draw(Label("$\pi_{z}$", 0.5*pos, align=E), (0, -2.2)--(0, -3.2), Arrow(arsize));

// Axes for the floor.
draw(Label("$y$", pos, align=N),  (-3, -4.2)--( 3, -4.2), Arrow(arsize));
draw(Label("$x$", pos, align=NW), ( 1, -3.2)--(-1, -5.2), Arrow(arsize));
