...
/*  The size of an image for size_64_default_settings is... 64.               */
size(64);
...
pen label_size = fontsize(8pt);
pen dash_type = linetype("4 4");
pen thin_line_width = linewidth(0.2pt);
pen line_width = linewidth(0.4);
pen thick_line_width = linewidth(0.7);
