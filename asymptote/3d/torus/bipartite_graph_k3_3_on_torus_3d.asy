...
triple c0(real t)
{
    return draw_line(t, V[3], V[1] + (0.0, 1.0));
}

triple c1(real t)
{
    return draw_line(t, V[3], V[2] + (0.0, 1.0));
}

triple c2(real t)
{
    return draw_line(t, V[5], V[0] + (1.0, 0.0));
}

triple c3(real t)
{
    return draw_line(t, V[4], V[2] + (0.0, 1.0));
}

triple c4(real t){return draw_line(t, V[0], V[3]);}
triple c5(real t){return draw_line(t, V[0], V[4]);}
triple c6(real t){return draw_line(t, V[1], V[4]);}
triple c7(real t){return draw_line(t, V[1], V[4]);}
triple c8(real t){return draw_line(t, V[1], V[5]);}
triple c9(real t){return draw_line(t, V[2], V[5]);}
