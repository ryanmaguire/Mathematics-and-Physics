...
/*  The size of an image for size_128_default_settings is... 128.             */
size(128);
...
pen label_size = fontsize(10pt);
pen dash_type = linetype("4 4");
pen thin_line_width = linewidth(0.3pt);
pen line_width = linewidth(0.5);
pen thick_line_width = linewidth(0.8);
