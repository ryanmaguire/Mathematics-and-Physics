...
pair[] Vpts = {(2.3, 0.0), (2.6, 0.6), (3.5, 0.0), (3.2, -0.6), (2.3, -0.5)};
real[] Vangles = {80.0, 0.0, -90.0, 180.0, 150.0};
int nVpts = 5;

pair[] Upts = {(0.3, 0.0), (0.6, 0.6), (1.5, 0.0), (1.2, -0.6), (0.5, -0.4)};
real[] Uangles = {40.0, 0.0, -60.0, 180.0, 150.0};
int nUpts = 5;

pair[] Cpts = {(0.7, 0.0), (0.7, 0.2), (1.0, 0.2), (1.0, -0.2), (0.8, -0.1)};
real[] Cangles = {90.0, 0.0, 0.0, 180.0, 200.0};
int nCpts = 5;

pair[] Dpts = {(2.5, 0.0), (2.7, 0.2), (3.3, 0.0), (3.0, -0.3), (2.5, -0.2)};
real[] Dangles = {30.0, 0.0, -90.0, 180.0, 150.0};
int nDpts = 5;
...
g = PathFromPointsAndAngles(Cpts, Cangles, nCpts, true);
filldraw(g, Cpen, black);

g = PathFromPointsAndAngles(Dpts, Dangles, nDpts, true);
filldraw(g, Dpen, black);

/*  Label X, U, V, and the points x and y.                                    */
label("$\mathcal{C}$", xpt, SE);
label("$\mathcal{D}$", ypt, SE);
label("$X$", (1.7, 0.8));
label("$\mathcal{U}$", (1.1, -0.3));
label("$\mathcal{V}$", (2.7, -0.5));
