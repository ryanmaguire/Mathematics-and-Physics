...
draw(graph(tref, -1.29, -0.35), MidSharpArrow(arsize));
draw(graph(tref, -0.35, 0.75), MidSharpArrow(arsize));
draw(graph(tref, 0.8, 1.6), MidSharpArrow(arsize));
draw(graph(tref, 1.6, 2.85), MidSharpArrow(arsize));
draw(graph(tref, 2.9, 3.45), MidSharpArrow(arsize));
draw(graph(tref, 3.45, 4.94), MidSharpArrow(arsize));
...
label("start", scale(1.1)*tref(0.0), fontsize(7pt));
label("U0- O1- U2- O0- U1- O2-", (0.0, -2.8), fontsize(7pt));
