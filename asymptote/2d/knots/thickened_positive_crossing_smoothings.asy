...
draw(reverse((0.1, 0.1) -- (0.25, 0.25)), SharpArrow(arsize));
draw(reverse((0.75, 0.75) -- (0.9, 0.9)), SharpArrow(arsize));
...
draw(reverse((2.1, 0.1) -- (2.25, 0.25)), SharpArrow(arsize));
draw(reverse((2.75, 0.75) -- (2.9, 0.9)), SharpArrow(arsize));
