...
void draw_hex(pair Center, real radius, pen color)
{
...
/*  Table for checking if a hexagon has been played.                          */
int[] have_played;
...
for (m = 0; m < N; ++m)
{
    for (n = 0; n < N; ++n)
    {
        ...
        draw_hex(T*O, r, white);

        /*  Set have_played to zero.                                          */
        have_played[m*N + n] = 0;
    }
}
