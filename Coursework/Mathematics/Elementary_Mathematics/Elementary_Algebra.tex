...
\begin{document}
    ...
    \section{Basic Notions}
        \subsection{Sets}
            ...
            \begin{fexample}{More Examples of Sets}
                {Elem_Alg_More_Examples_of_Sets}
                \begin{enumerate}
                    \begin{multicols}{2}
                        \item $\{1,2,3\}$
                        \item $\{a,b,c\}$
            ...
            In mathematics, two things are equal if they are
            ...
            again we can see that the blob $A$ is entirely
            contained in the blob $B$, and thus
            ...
            The symbols
            $\subset$ and $\subseteq$ work in a similar manner.
