...
\begin{document}
    ...
    \section{Basic Notions}
        \subsection{Sets}
            ...
            with a primary focus on the set of
            real numbers.
            ...
            If we let $A=\{1,2,3\}$, then using our
            set notation we have that $1\in{A}$,
            ...
            For example, $\{1,2,3,\hdots\}$
            is the set of all positive integers,
            $\{2,4,6,8,\hdots\}$ is the set of all
            even integers, and $\{1,3,5,7,9,\hdots\}$
            is the set of all odd integers. The second
            way to describe a set is using the so
            called Set-Builder notation. To write out
            ...
            sets contain
            complete different elements.
            An important concept in in the study of
            ...
            we can see that for
            any set $A$, $A$ is a subset of itself.
            For any element
            ...
            \begin{fdefinition}{Proper Subset}
                {Elementary_Algebra_Proper_Subset}
