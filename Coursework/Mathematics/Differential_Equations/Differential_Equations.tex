    ...
    \section{Systems of Differential Equations}
        \subsection{Linear First Order Systems}
            ...
            \begin{subequations}
                ...
                \end{align}
            \end{subequations}
            We can decouple this system and then apply the methods we've
            found before for purely real ordinary differential equations.
            Thus, complex coefficients do not make the problem any more
            difficult. As a final example, we consider the phenomena of
