...
\begin{document}
    ...
    \section{Old Notes}
        \subsection{Summary of Lectures}
            ...
            \subsubsection{Normed Spaces and Banach Spaces}
                ...
                if and only if it is closed. There are things
                like series and Schauder basis.
                A Schauder basis implies the space is separable.
            ...
            \subsubsection{Linear Operators}
                Stuff about identity, zero, differentiation,
                and integration. Domain of a linear operator,
                range of a linear operator, and the null space.
    ...
    \section{A Review of Real Analysis}
        ...
        \subsection{Continuity}
            ...
            $f(x)=0$. This function, which is known as
            Dirichlet's Function, but also as the Popcorn
            Function of Thomas' Function, is continuous at every
