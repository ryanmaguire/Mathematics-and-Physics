...
\centering
\begin{tikzpicture}[scale=0.8,axis/.style={very thick, ->, >=stealth'},
...
\label{fig:usr_geo_bending_angle}
\end{wrapfigure}
...
\newglossarystyle{clong}{%
 \renewenvironment{theglossary}%
     {\begin{longtable}{p{.4\hsize}p{0.5295\hsize}}}%
     {\end{longtable}}%
