...
\chapter{Set Theory}
    ...
    \section{Sets and Logic}
        ...
        \subsection{Logical Connectives}
            ...
            \gls{conjunction}.\index{Conjunction}
            \begin{table}[H]
                \centering
                \begin{tabular}{c | c | c}
                    $P$&$Q$&$P\land{Q}$\\
            ...
            antarctic. We may truthfully say
            \begin{center}
            ...
            or and the exclusive or.\index{exclusive or}
            ...
            \textit{logical equivalence}\index{Logical Equivalence}.
            ...
            \index{De Morgan's Law!of Conjunction}
            \begin{equation}
                \neg(P\land{Q})=(\neg{P})\lor(\neg{Q})
            \end{equation}
            ...
            \index{De Morgan's Law!of Disjunction}
            \begin{equation}
                \neg(P\lor{Q})=(\neg{P})\land(\neg{Q})
            \end{equation}
        ...
        \subsection{The Axioms of Set Theory}
            ...
            \index{Axiom!of Unrestricted Comprehension} said
            ...
            which we will not really need, can be used to prove there is no
            \textit{set of all sets}, avoiding Russell's paradox.
            \par\hfill\par
            The \textit{axiom of union}\index{Axiom!of Union}
            ...
            \begin{definition}[\textbf{Union of Two Sets}]
                ...
                \gls{AcupB} defined by:\index{Union!of Two Sets}
                \begin{equation}
            ...
            \index{Intersection!of a Collection}
            ...
            \begin{definition}[\textbf{Intersection of Two Sets}]
                ...
                $A\cap{B}$ defined by:\index{Intersection!of Two Sets}
                \begin{equation}
        ...
        \subsection{The Algebra of Sets}
            ...
            \begin{example}
                ...
                $A\setminus{B}=A$.\index{Disjoint Sets}
            \end{example}
            \begin{example}
            ...
            \begin{theorem}[\textbf{Distributive Law of Unions}]
                ...
                \index{Distributive Law!of Unions}
            \end{theorem}
            \begin{proof}
            ...
            \begin{theorem}[\textbf{Distributive Laws of Intersections}]
                ...
                \index{Distributive Law!of Intersections}
            \end{theorem}
            \begin{proof}
            ...
            \begin{theorem}[\textbf{De Morgan's Law of Unions}]
                ...
                \index{De Morgan's Law!of Unions}
                \begin{equation}
                    X\setminus(A\cup{B})=
            ...
            \begin{theorem}[\textbf{De Morgan's Law of Intersections}]
                If $X$, $A$, and $B$ are sets, then:%
                \index{De Morgan's Law!of Intersections}
                \begin{equation}
                    X\setminus(A\cap{B})=
    ...
    \section{Functions and Relations}
        ...
        \begin{definition}[\textbf{Ordered Pair}]
            The \gls{ordered pair} $(a,\,b)$ is the set:\index{Ordered Pair}
            \begin{equation}
                (a,\,b)=\big\{\,\{\,a\,\},\,\{\,a,\,b\,\}\big\}
            \end{equation}
