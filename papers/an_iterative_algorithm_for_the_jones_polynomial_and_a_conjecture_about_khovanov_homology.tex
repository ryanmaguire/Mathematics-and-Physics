...
\begin{document}
    ...
    \section{The Circle Counting Algorithm}
        ...
        memory.
        \par\hfill\par
        Because of the 16 possibilies, the full algorithm is lengthy. To make
        ...
        this iterative method is that it does not requires only $O(N)$ space,
    ...
    \section{Results}
        ...
        detects the unknots. That is, if a given knot has the same Khovanov
        ...
        The 12 crossing knot K12n749 has the same Jones'
        polynomial as the the torus knot $T(2,7)$. In both instances the
        Khovanov homologies were different, leading to the following conjecutre:
        ...
        and the knot K12n475 matches $m_{3}$.
        \begin{table}
            \centering
            \begin{tabular}{c | c}
                HT Table&Twist Knot\\
