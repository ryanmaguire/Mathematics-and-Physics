...
\begin{document}
    ...
    \section{Transverse Knots and Links}
        Transverse links are links that are everywhere transverse to the
        standard contact structure. That is, at every point $p$ on the link the
        velocity vector and the hyperplane at $p$ span $\mathbb{R}^{3}$.
    ...
    \section{Numerical Results}
        ...
        Khovanov polynomial of $T(11,2)$.
    \section{Acknowledgements}
        Sam, Jacob, Nikolay Pultsin, more.
        Something about connected sum of two Hopf links.
        Vladimir, please feel fill in this part :)
    \section{Future Work}
