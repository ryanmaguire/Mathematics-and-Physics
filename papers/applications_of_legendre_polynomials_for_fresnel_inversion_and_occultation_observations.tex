...
\begin{document}
    ...
    \section{Fourier Optics in a Ring System}
        ...
        \end{equation}
        The quantity $\psi$ called the \textit{Fresnel kernel} and is purely
    ...
    \section{The Fresnel Approximation}
        ...
        (MTR86), and we can see that excellent relative error is achieved
        across the entire Maxwell ringlet. It is worth noting that for Rev007
        the Fresnel method is 20 times faster than the Newton-Raphson algorithm,
        and recovers a very nice ring profile.
        \begin{figure}
            \centering
            \resizebox{\textwidth}{!}{%
                \includegraphics{Rev007EMaxwellRinglet500MetersNewtonVsFresnel}
            }
    ...
    \section{Applications of Legendre Polynomials}
        ...
        relative error is improved a bit across the entire ringlet, but the
        ...
        \begin{figure}
            ...
            \resizebox{\textwidth}{!}{%
                \includegraphics{%
                    Rev007EMaxwellRinglet500MetersNewtonVsFresnelVsLegendre%
                }
            }
    ...
    \section{Implementation and Results}
        Direct evaluation of the modified Legendre polynomial using
        ...
        this reconstruction technique. See GRESH for a careful examination
        of diffraction with elliptical rings.
        \begin{figure}
            \centering
            \resizebox{\textwidth}{!}{%
                \includegraphics{UranusRingSix010MeterNewtonVsFresnelVsLegendre}
            }
