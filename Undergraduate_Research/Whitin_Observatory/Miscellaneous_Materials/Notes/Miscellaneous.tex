    ...
    \subsection{Other Notes}
        ...
        \subsubsection{Dick Simpson's RSR-Reading Program}
            ...
            \begin{enumerate}
                ...
                \item Run the MATLAB codes to produce plots and create
                      a one-page PDF of results by inserting figures
                      in the MS-word template file.
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        \captionsetup{type=figure}
        \includegraphics[width=\textwidth]{gjs_matlab_vs_idl_%
                                           averaging_cRingRipple_diff}
    \end{subfigure}
    \begin{subfigure}[b]{0.49\textwidth}
        \captionsetup{type=figure}
        \includegraphics[width=\textwidth]{gjs_matlab_vs_idl_%
                                           averaging_cRingRipple}
    \end{subfigure}
\end{figure}
