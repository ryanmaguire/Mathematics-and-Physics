...
\section{The Axioms of ZF}
    ...
    by Bertrand Russell\index{Bertrand Russell} in 1901. Allow us to neglect
    this requirement, for a moment, to reveal why it is essential. recall from
    logic that a system of mathematics inconsistent if one can prove a
    ...
    Ernst Zermelo\index{Ernst Zermelo}. Subtle problems were pointed out by
    Abraham Fraenkel\index{Abraham Fraenkel} in 1920, and in 1921 the system of
    ...
    \subsection{Subsets and Equality}
        ...
        \index{Axiom of Extensionality}. First, we define the use of the symbol
        ...
        using the language of subsets\index{Subset}. This will make proving
        ...
        proper subsets\index{Proper Subset}, and we can define them in terms of
        equality.
        ...
        (the \textit{real} numbers)\index{Real Numbers} as follows:
        \begin{equation}
        ...
        \index{Axiom Schema of Specification}. It is important to note that
    ...
    \subsection{Ordered Pairs and Unions}
        ...
        we'll adopt is due to Kuratowski\index{Kazimierz Kuratowski} and uses
        the following form:
        \begin{equation}
        ...
        (Ax.~\ref{ax:Axiom_of_Extensionality}), the set $C$ hypothesized in
        ...
        \begin{fdefinition}{Ordered Pairs}{Ordered_Pairs}
            ...
            \end{equation*}
        \end{fdefinition}
        Kuratowski\index{Kazimierz Kuratowski} first put forward this definition
        ...
        \index{Norbert Wiener}, put forward in 1914. His definition grew out of
        Bertrand Russell's\index{Bertrand Russell} Type Theory\index{Type Theory}
        ...
        is often called the indexing set\index{Index Set}.
        ...
        pairing\index{Axiom of Pairing}, combined with that of union proves
        such a thing exists.
        \begin{theorem}
    ...
    \subsection{Cartesian Products and Functions}
        ...
        \begin{proof}
            ...
            from $A$ to $B$.
        \end{proof}
        There is some strange notation when discussing the set of all functions
        ...
        \textit{continuous} has meaning. Since the notation is not universal or
        standard across the various disciplines, an attempt will be made to
        specify what $B^{A}$ or $\mathcal{F}(A,B)$ means before using it in a
        ...
        \begin{figure}[H]
            ...
            \begin{tikzpicture}[>=Latex]
                ...
                \draw[fill=blue!80!white]
                    (S1)    to[out=-150,in=180] (S2)
                            to[out=0,   in=-90] (S3)
                            to[out=90,  in=-60] (S4)
                            to[out=120, in=30]  cycle;

                \draw[fill=red!80!white]
                    (T1)    to[out=-150,in=180] (T2)
                            to[out=0,   in=-90] (T3)
                            to[out=90,  in=0] (T4)
