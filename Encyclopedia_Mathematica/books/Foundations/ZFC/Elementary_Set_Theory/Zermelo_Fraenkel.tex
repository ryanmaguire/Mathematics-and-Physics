...
\section{The Axioms of Zermelo and Fraenkel}
    ...
    \subsection{Ordered Pairs and Unions}
        ...
        \textit{open interval}\index{Open Interval} defined open something
        called a \textit{partially ordered set}\index{Partially Ordered Set}.
        ...
        \index{Union (Sets)} over the set $\mathcal{O}$.
        \begin{fdefinition}{Union over a Set}{Union_over_a_Set}
            ...
            \end{equation*}
        \end{fdefinition}
        The set $\mathcal{O}$ is often called the indexing set\index{Index Set}.
    ...
    \subsection{Cartesian Products and Functions}
        ...
        \end{figure}
        If we consider a function $f:X\rightarrow{Y}$ and the image of the
