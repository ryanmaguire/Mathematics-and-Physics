...
\section{The Axioms of ZF}
    ...
    \begin{fexample}{Using Element Notation}{Using_Element_Notation}
        ...
        \textit{a is an element of A}, or \textit{a is contain in A},
    ...
    \subsection{Subsets and Equality}
        ...
        \begin{fexample}{Examples of Subsets}{Examples_of_Subsets}
        ...
        \begin{proof}
            ...
            and $B\subseteq{A}$.
        \end{proof}
        We can use Thm.~\ref{thm:Equivalent_Def_of_Equality} to redefine the
        notion of equality in terms of subsets.
        ...
        separation.
        \begin{fexample}{Set-Builder Notation}{Set_Builder_Evens_and_Odds}
    ...
    \subsection{Ordered Pairs and Unions}
        ...
        \begin{ltheorem}{Existence of Ordered Pairs}{Existence_of_Ordered_Pairs}
            ...
            for all $x$, $x\in(A,\,B)$ if only if $x=\{A\}$ or $x=\{A,B\}$.
        \end{ltheorem}
        \begin{proof}
        ...
        \begin{fexample}{Ordered Pairs Distinguish Order}
        ...
        \begin{fdefinition}{Intersection Over a Collection}
            ...
            \begin{equation}
                ...
                =\Big\{\,x\in\bigcup_{E\in\mathcal{O}}E\;|\;x\in{E}
