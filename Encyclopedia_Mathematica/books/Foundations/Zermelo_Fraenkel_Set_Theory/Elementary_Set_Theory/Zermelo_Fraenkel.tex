...
\section{The Axioms of ZF}
    ...
    \begin{lexample}{More Examples of Element Notation}
        ...
        \end{subequations}
        \par\vspace{2.5ex}
        If we let $\mathbb{Z}_{n}$ denote all of the positive integers
    ...
    \subsection{Ordered Pairs}
        ...
        not have order. We can develop a new type object, called ordered
        pairs, that can distinguish between such things. The definition we'll
        adopt is due to Kuratowski and uses the following form:
        \begin{equation}
            (a,\,b)=\big\{\,a,\,\{\,a,\,b\,\}\,\big\}
        \end{equation}
        ...
        \begin{proof}
            ...
            there exists a set $\mathcal{C}$ such that $A\in\mathcal{C}$ and
        ...
        \begin{proof}
            ...
            (Thm.~\label{thm:Existence_of_Set_Built_from_Two_Sets}).
        ...
        \begin{fdefinition}{Union of Two Sets}{Union_of_Two_Set}
