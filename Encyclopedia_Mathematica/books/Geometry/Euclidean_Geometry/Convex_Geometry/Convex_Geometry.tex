    ...
    \section{Convexity: Part I}
        ...
        \subsection{Convexity in the Euclidean Plane}
            ...
            \begin{figure}[H]
                ...
                \input{tikz/Convex_Geometry_Circle_1.tex}
            ...
            \begin{figure}
                \centering
                \captionsetup{type=figure}
                \input{tikz/Convex_Geometry_Convex_Figure_1.tex}
            ...
            \begin{figure}[H]
                \centering
                \captionsetup{type=figure}
                \input{tikz/Convex_Geometry_Lines_1.tex}
        ...
        \section{An Uninteresting Algebraic Structure}
            ...
            \begin{proof}
                For:
                \begin{equation}
                    e_{\circ}=e_{\circ}\circ e_{\circ}'=e_{\circ}'
                \end{equation}
                And thus $e_{\circ}$ is unique. Similarly for $e_{*}$.
            \end{proof}
            \begin{theorem}
                ...
                \begin{subequations}
                    \begin{minipage}[t]{0.49\textwidth}
                        \begin{align}
                            a
                            &=a*e_{*}\tag{Identity}\\
                            &=a*(a\circ{a}^{\minus{1}})\tag{Pseudo-Inverse}\\
                            &=(a*a)\circ(a*a^{\minus{1}})\tag{Distributivity}
                        \end{align}
                    \end{minipage}
                    \hfill
                    \begin{minipage}[t]{0.49\textwidth}
                        \begin{align}
                            &=(a*a)\circ{e}_{\circ}\tag{Pseudo-Inverse}\\
                            &=a*a\tag{Identity}
                        \end{align}
                    \end{minipage}
                \end{subequations}
            ...
            \end{proof}
            \begin{theorem}
                The pseudo-inverses are unique.
            \end{theorem}
            \begin{proof}
                For suppose $a^{\minus{1}}$ and $a'^{\minus{1}}$ are both
                pseudo-inverses for some $a\in{S}$. Then:
                \begin{align}
                    a'^{\minus{1}}
                    &=a'^{\minus{1}}*e_{*}
                    \tag{Identity}\\
                    &=a'^{\minus{1}}*(a\circ{a^{\minus{1}}})
                    \tag{Pseudo-Inverse}\\
                    &=(a'^{\minus{1}}*a)\circ
                      (a'^{\minus{1}}*a^{\minus{1}})
                    \tag{Distributivity}\\
                    &=e_{\circ}\circ(a^{\minus{1}}*a^{\minus{1}})
                    \tag{Pseudo-Inverse}\\
                    &=a'^{\minus{1}}*a^{\minus{1}}
                    \tag{Identity}\\
                    &=a^{\minus{1}}*a'^{\minus{1}}
                    \tag{Commutativity}\\
                    &=(a^{\minus{1}}*a'^{\minus{1}})\circ{e}_{\circ}
                    \tag{Identity}\\
                    &=(a^{\minus{1}}*a'^{\minus{1}})\circ(a^{\minus{1}}*a)
                    \tag{Pseudo-Inverse}\\
                    &=a^{\minus{1}}\circ(a*a'^{\minus{1}})
                    \tag{Distributivity}\\
                    &=a^{\minus{1}}\circ{e}_{\circ}
                    \tag{Pseudo-Inverse}\\
                    &=a^{\minus{1}}
                    \tag{Identity}
                \end{align}
                Thus, the pseudo-inverse is unique.
            \end{proof}
            \begin{theorem}
            ...
            \begin{proof}
                ...
                \begin{align}
                    a&=a\circ(a^{-1}*(a^{-1})^{-1})\\
                     &=(a\circ a^{-1})*(a\circ (a^{-1})^{-1})\\
                     &=a\circ(a^{-1})^{-1}
                \end{align}
                Similarly, $a = a* (a^{-1})^{-1}$.
                But if $a = a\circ (a^{-1})^{-1} = a*(a^{-1})^{-1}$, then $a = (a^{-1})^{-1}$.
            \end{proof}
