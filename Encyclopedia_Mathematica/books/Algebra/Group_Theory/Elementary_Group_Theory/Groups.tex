\section{Groups}
    ...
    \end{example}
    We've that a unital element of a binary operation is unique
    ...
    compute the inverse of a product. This requires both the existence of
    inverses and an associative operation.
    \begin{theorem}
