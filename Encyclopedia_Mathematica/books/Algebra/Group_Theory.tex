...
\chapter{Group Theory}
    \section{Relations}
        ...
        \begin{proof}
            ...
            Therefore, etc.
        \end{proof}
        \begin{ldefinition}{Symmetric Relations}{Symmetric_Relations}
            A symmetric relation on a set $A$ is a
            relation $R$ on $A$ such that for all $a,b\in{A}$
            such that $aRb$, it is true that $bRa$.
        \end{ldefinition}
        \begin{ldefinition}{Transitive Relation}{Transitive_Relations}
        ...
        \begin{ldefinition}{Transitive Closure}{Transitive_Closure}
            ...
            \end{equation}
        \end{ldefinition}
        \begin{ldefinition}{Asymmetric Relation}{Assymetric_Relation}
    ...
    \section{Functions}
        ...
        will write $f(a)=b$.
        \begin{ldefinition}{Image of a Set}{Image_of_a_Set}
        ...
        \begin{ldefinition}{Pre-Image}{Pre_Image}
        ...
        \begin{ldefinition}{Injective Functions}{Injective_Functions}
        ...
        \begin{ldefinition}{Inverse of Injective Functions}
                           {Inverse_of_Injective_Functions}
            ...
            that $f(x)=y$.
        \end{ldefinition}
        \begin{ldefinition}{Surjective Functions}{Surjective_Functions}
        ...
        \end{ldefinition}
        \begin{ldefinition}{Bijective Functions}{Bijective_Functions}
