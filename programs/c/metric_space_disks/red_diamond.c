 ...
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Draw a diamond with a red-to-black gradient.                          *
 ******************************************************************************/
...
/*  Function for drawing a diamond with a red-to-black gradient.              */
int main(void)
{
    ...
    struct msd_ppm PPM = msd_ppm_create("red_diamond.ppm");
...
#pragma omp parallel for
    ...
    for (n = 0U; n < size; ++n)
    {
        ...
        /*  Points inside the diamond are given a red-to-black gradient.      */
            ...
            c[n] = msd_color_scale(&msd_red, 1.0 - dist);
    }
