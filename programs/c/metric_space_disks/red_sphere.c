 ...
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Draw a circle with a red-to-black gradient.                           *
 ******************************************************************************/
...
/*  Function for drawing a sphere with a red-to-black gradient.               */
int main(void)
{
    ...
    struct msd_ppm PPM = msd_ppm_create("red_sphere.ppm");
...
#pragma omp parallel for
    ...
    for (n = 0U; n < size; ++n)
    {
        ...
        /*  Points inside the circle are given a red-to-black gradient.       */
        else
