 ...
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Draw a circle with a white-to-black gradient.                         *
 ******************************************************************************/
...
/*  Function for drawing a sphere with a white-to-black gradient.             */
int main(void)
{
    ...
    struct msd_ppm PPM = msd_ppm_create("sphere.ppm");
...
#pragma omp parallel for
    ...
    for (n = 0U; n < size; ++n)
    {
        ...
        /*  Points inside the circle are given a white-to-black gradient.     */
        else
