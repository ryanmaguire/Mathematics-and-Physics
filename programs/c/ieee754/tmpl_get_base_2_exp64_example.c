 ...
 *      gcc tmpl_get_base_2_exp64_example.c -o test -ltmpl                    *
 ...
 *          tmpl_get_base_2_exp64_example.c -o test -ltmpl                    *
...
int main(void)
{
    ...
    b0 = tmpl_Get_Base_2_Exp64(w0);
    b1 = tmpl_Get_Base_2_Exp64(w1);
    b2 = tmpl_Get_Base_2_Exp64(w2);
    b3 = tmpl_Get_Base_2_Exp64(w3);
