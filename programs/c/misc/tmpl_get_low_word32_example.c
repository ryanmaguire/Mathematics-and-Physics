 ...
 *      gcc tmpl_get_low_word32_example.c -o test -ltmpl                      *
 ...
 *          tmpl_get_low_word32_example.c -o test -ltmpl                      *
 *  We can the run the executable via:                                        *
 *      ./test                                                                *
 *  Which yielded the following results:                                      *
 *      Low Word of 8.000000: 0                                               *
 *      Low Word of 3.333333: 5592405                                         *
 *      Low Word of 0.500000: 0                                               *
 *      Low Word of 0.333333: 2796203                                         *
...
int main(void)
{
    ...
    b0 = tmpl_Get_Low_Word32(w0);
    b1 = tmpl_Get_Low_Word32(w1);
    b2 = tmpl_Get_Low_Word32(w2);
    b3 = tmpl_Get_Low_Word32(w3);
