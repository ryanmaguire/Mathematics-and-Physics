...
################################################################################
#   Purpose:                                                                   #
#       Compare Alexander polynomial of torus knots to other knots.            #
################################################################################
#   Author:     Ryan Maguire                                                   #
...
# The SnapPy and regina modules are used for computations with knots.
import snappy
import regina
...
for pd in fp:
    ...
    y = L.pd().replace("PD","").replace("X","").replace(" ","")
