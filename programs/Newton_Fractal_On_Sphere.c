...
const unsigned char MaxIters = 32;
...
static unsigned char **get_colors(void)
{
    ...
    /*  Champagne. */
    colors[9][0] = (unsigned char)255;
    colors[9][1] = (unsigned char)85;
    colors[9][2] = (unsigned char)0;
...
static root_struct *get_roots(void)
{
    ...
    unsigned int m, n, ell, iter, max_iter, s, N, n_roots;
