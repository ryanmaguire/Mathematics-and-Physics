...
\if\compilefoundations0
    \externaldocument{./books/references_foundations}
\fi

\if\compilealgebra0
    \externaldocument{./books/references_algebra}
\fi

\if\compiletopology0
    \externaldocument{./books/references_topology}
\fi
...
\begin{document}
    ...
    \if\compilefoundations1
        \chapter*{Preface}
            ...
            \input{books/Front_Matter/preface.tex}
        \clearpage
        \chapter*{Acknowledgements}
            \addcontentsline{toc}{chapter}{Acknowledgements}
            \input{books/Front_Matter/Acknowledgements.tex}
        \clearpage
        \pagenumbering{gobble}
        \book{Foundations}
