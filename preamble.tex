...
\usepackage[font=scriptsize]{subcaption}%Subfigure captions.
\usepackage[
    font={scriptsize,it}
...
% Defined numbered italicized environments.
\newtheorem{theorem}{Theorem}[section]
\newtheorem{lemma}{Lemma}[section]
\newtheorem{corollary}{Corollary}[section]
\newtheorem{proposition}{Proposition}[section]
% Defined unnumbered italicized environments.
\newtheorem*{theorem*}{Theorem}
% Use default font for various environments.
\theoremstyle{normal}
