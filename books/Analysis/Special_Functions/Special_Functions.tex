\section{Special Functions}
    ...
    \subsection{The Fresnel Integrals}
        ...
        \begin{ldefinition}{Fresnel Integrals}
            ...
            \par
        \end{ldefinition}
        Graph of the Fresnel Sine and Fresnel Cosine functions are shown in
        Fig.~\ref{fig:Graph_Fresnel_Cos}.
        \begin{figure}[H]
            \centering
            \captionsetup{type=figure}
            \includegraphics{images/Fresnel_Cos.pdf}
        ...
        \begin{figure}[H]
            \centering
            \captionsetup{type=figure}
            \includegraphics{images/Fresnel_Sin.pdf}
        ...
        \begin{figure}[H]
            \centering
            \captionsetup{type=figure}
            \input{tikz/Complex_Plane_Fresnel_Integral_Path.tex}
