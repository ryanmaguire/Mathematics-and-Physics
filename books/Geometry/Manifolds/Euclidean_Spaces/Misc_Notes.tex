...
\section{Lee Chapt 1}
    ...
    \begin{theorem}
        ...
        $\Delta\subseteq{B}$.
    \end{theorem}
    In particular, topological manifolds are paracompact.
    \begin{theorem}
    ...
    \par\hfill\par
    More generally, the space of $M\times{N}$ matrices of full rank, which is a
    ...
    \begin{subequations}
        ...
        \end{align}
    \end{subequations}
    And this is a smooth function. More generally, if
