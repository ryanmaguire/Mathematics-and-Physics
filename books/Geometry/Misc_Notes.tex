...
\begin{document}
    ...
    \section{A Review of Topology}
        Def dense, compact, connected, path connected, Hausdorff, basis.
        \begin{definition}
        ...
        \begin{example}
            ...
            \end{equation}
            that is, we rotate asymuthally by $\theta$.
            \begin{figure}[H]
                \centering
...
\begin{tikzpicture}[
    ...
    \def\AngleA{60};
    \def\Radius{3.2};
    \def\RadiusA{1.845 and 0.5};
    \draw[blue] (0, -\Radius) to (0, \Radius);
    \draw (O) circle (\Radius);

    \draw[draw=none, fill=red!80!white, opacity=0.5]
        (O) ellipse ({\Radius} and 0.8);

    \draw[draw=none, fill=red!80!white, opacity=0.5]
        (0, 2.52) ellipse (1.845 and 0.5);

    \draw (180-\AngleA:\Radius) arc(180-\AngleA/2:360+\AngleA/2:\RadiusA);
    \draw[->-] (-\Radius, 0) arc(180:360:{\Radius} and 0.8);

    \begin{scope}[densely dashed]
        \draw[->-] (\Radius, 0) arc(0:180:{\Radius} and 0.8);
        \draw (\AngleA:\Radius) arc(\AngleA/2:180-\AngleA/2:1.845 and 0.5);
    \end{scope}
\end{tikzpicture}
            \end{figure}
