...
\section{Convexity: Part I}
    ...
    \subsection{Convexity in the Euclidean Plane}
        ...
        \begin{figure}[H]
            \centering
            \captionsetup{type=figure}
            \includegraphics{images/Semicircle_1.pdf}
            \caption{Caption}
            \label{fig:my_label}
        \end{figure}
        \begin{definition}
        ...
        \begin{figure}[H]
          \begin{subfigure}[b]{0.49\textwidth}
             \centering
            \includegraphics{images/Circle_3.pdf}
            \caption{Drawing for Theorem 3.2.15}
          \end{subfigure}
          \begin{subfigure}[b]{0.49\textwidth}
            \centering
            \includegraphics{images/Circle_4.pdf}
        ...
        \begin{figure}[H]
            \centering
            \captionsetup{type=figure}
            \includegraphics{images/Triangle_1.pdf}
            \caption{Triangle}
        \end{figure}
        \end{proof}
        \begin{theorem}[The Law of Sines]
