...
\begin{document}
    ...
    \section{Groups}
        ...
        \subsection{Dihedral Groups}
            ...
            \end{proof}
            \begin{example}
                We can also consider the dihedral group on two points. This is
                the group of symmetries on a line segment. As one might guess,
                the reflection and rotation elements are identity. We have the
                presentation:
                \begin{equation}
                    D_{4}=\langle{r,f}\;|\;r^{2}=e,f^{2}=e,\rangle
                \end{equation}
            \end{example}
