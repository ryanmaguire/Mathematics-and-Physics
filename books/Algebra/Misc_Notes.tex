...
\begin{document}
    ...
    \section{DF Chapter 1}
        ...
        \begin{theorem}
            ...
            If $n,m\in\mathbb{N}^{+}$, then there exists $q,r\in\mathbb{N}$ such
            that $n=q\cdot{m}+r$ with $r<m$.
        \end{theorem}
        \begin{proof}
            ...
            works. If $n=m$, $q=1$ and $r=0$ does the trick. Otherwise, $G$ is
            non-empty and bounded since it is bounded by $n$, and hence there is
            a greatest element. Let $k\in{G}$ be the greatest element, and let
            $r=n-k\cdot{m}$. Since $k\in{G}$, $r>0$. Moreover, $r<m$. For if
            not, then $r-m=n-k\cdot{m}-m=n-(k+1)\cdot{m}\geq{0}$, which
            contradicts the maximality of $k$. But then $n=km+r$ and $r<m$.
        \end{proof}
    ...
    \section{Modulo Arithmetic}
        \begin{theorem}
            ...
            If $n\in\mathbb{N}$, and if $R\subseteq\mathbb{Z}\times\mathbb{Z}$
            is defined by:
            \begin{equation}
