\section{The Structure of Sets}
    ...
    \subsection{Basic Theorems}
        ...
        \textit{Elements}\index{Elements, The (Euclid)}, common notion 1 reads:
    ...
    \subsection{Operations on Sets}
        ...
        \begin{figure}[H]
            ...
            \input{tikz_figures/set_theory/Venn_Diagram_Union_with_Subset.tex}
        ...
        intersections, as well as the De Morgan Laws\index{De Morgan's Laws}.
        ...
        \begin{figure}[H]
            ...
            \captionsetup{type=figure}
            \centering
            \input{tikz_figures/set_theory/Venn_Diagram_Intersection_with_Subset.tex}
        ...
        \begin{figure}[H]
            \centering
            \captionsetup{type=figure}
            \input{tikz_figures/set_theory/Venn_Diagram_Distributive_Law_of_Unions.tex}
        ...
        \begin{figure}[H]
            \centering
            \captionsetup{type=figure}
            \input{tikz_figures/set_theory/Venn_Diagram_Distributive_Law_of_Intersections.tex}
        ...
        \begin{figure}[H]
            \centering
            \captionsetup{type=figure}
            \input{tikz_figures/set_theory/Venn_Diagram_Compare_Dist_Laws_Unions_Intersections.tex}
            \caption{Figure for
        ...
        \begin{figure}[H]
            \centering
            \captionsetup{type=figure}
            \input{tikz_figures/set_theory/Venn_Diagram_Set_Difference.tex}
        ...
        \begin{figure}[H]
            \centering
            \captionsetup{type=figure}
            \input{tikz_figures/set_theory/Venn_Diagram_Symmetric_Difference.tex}
