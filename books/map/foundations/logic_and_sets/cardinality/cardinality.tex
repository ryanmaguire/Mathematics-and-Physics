\section{Cardinality}
    ...
    \subsection{Equivalent Sets}
        ...
        \begin{figure}[H]
            ...
            \input{tikz_figures/set_theory/Surjection_From_N_to_Z.tex}
        ...
        \begin{figure}[H]
            ...
            \resizebox{0.7\textwidth}{!}{%
                \input{tikz_figures/set_theory/Surjection_From_N_to_Q_Plus.tex}
            }
        ...
        \begin{figure}[H]
            ...
            \captionsetup{type=figure}
            \resizebox{\textwidth}{!}{%
                \input{tikz_figures/set_theory/Surjection_From_N_to_Q.tex}
            }
            \caption{Diagram of a Surjection from
                     $\mathbb{N}$ onto $\mathbb{Q}$.}
        ...
        \begin{figure}[H]
            \centering
            \captionsetup{type=figure}
            \input{tikz_figures/set_theory/Bijection_Closed_to_Open_Interval.tex}
