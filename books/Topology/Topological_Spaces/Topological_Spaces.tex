...
\begingroup
    ...
    \chapter{Topological Spaces}
        ...
        \index{Continuous Function}\index{Function!Continuous}. The structure on
        ...
        concept of a \textit{topology}\index{Topology}, and from this we get the
        notion of a \textit{topological space}\index{Topological Space}. This
        chapter aims to define topologies and show examples of such spaces.
        \input{\PATH/Topological_Spaces/Topologies.tex}
