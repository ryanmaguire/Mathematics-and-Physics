    ...
    \chapter{Homotopy}
        ...
        \section{Cell Complexes}
            ...
            \subsection{Criteria for Homotopy Equivalence}
                ...
                one dimensional CW complex is homotopy equivalent to the wedge
                of circles. We've seen some use of this before when discussing
                lemniscates and the double punctured plane. Consider the graph
                shown below, which is the complete graph on 4 vertices. We take
                every edge that touches the central vertex and collapse it down
                to a point. The result is the wedge of three circles.
                \begin{figure}[H]
                    \centering
                    \captionsetup{type=figure}
