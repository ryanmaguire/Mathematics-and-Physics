...
\begin{document}
    ...
    \chapter{Homotopy}
        ...
        \section{Review}
            ...
            \subsection{Continuity}
                ...
                \begin{minipage}[t]{0.5\textwidth}
                    Both of these are
                    pictorial, the $\epsilon-\delta$ definition saying that if
                    we move at most $\delta$ in the $x$ direction, then we will
                    have no more than $\varepsilon$ amount of error in the $y$
                    direction (see Fig.~\ref{fig:Eps_Delta_Def_Cont}). The
                    sequence definition says that as we get arbitrarily close to
                    $x_{0}$ by any sequence $a:\mathbb{N}\rightarrow\nspace[]$,
                    then $f(a_{n})$ approaches $f(x_{0})$
                ...
                \begin{minipage}[t]{0.5\textwidth}
                    ...
                    familiar setting of a metric space. This can be obtain by
                    considering the following fundamental characterization of
                    continuous real-valued functions
                    $f:\mathbb{R}\rightarrow\mathbb{R}$. The function $f$ is
                    continuous \textit{if and only if} for every open subset
        ...
        \section{Homotopy Equivalence}
            ...
            \subsection{Homotopy}
                ...
                This notion is called \textit{homotopy}.
                \par\hfill\par
                ...
                \begin{minipage}{0.50\textwidth}
                    ...
                    $f,g:[0,1]\rightarrow{Y}$ are then just curves within the
                ...
                \begin{minipage}{0.50\textwidth}
                    ...
                    crescent-moon with a line connecting the poles. We can then
                    take body of our object and morph it into a sphere,
                    obtaining Fig.~\ref{fig:Sphere_with_String_Attached}. From
                    here we can proceed and drag the endpoints of the string
                    down towards the equator and obtain
                    Fig.~\ref{fig:Kettle_Bell}. This example demonstrates how
                    massively different spaces with homotopy equivalences can
                    be. Even the last two objects, which perhaps look similar
                    enough, are not homeomorphic.
                \end{minipage}
                \hfill
                \fbox{%
                    \begin{minipage}{0.44\textwidth}
                ...
                a sphere with one hole is homeomorphic to a disc. 
                \par\hfill\par
                \begin{minipage}[t]{0.52\textwidth}
                    First we prove the sphere with a hole is homeomorphic to the
                    plane $\nsphere[2]$, and then we conclude by showing
                ...
                \end{theorem}
                \begin{proof}
                    For let $f:S^{2}\setminus\{(0,0,1)\}\rightarrow\nspace[2]$
                ...
                \begin{proof}
                    ...
                    \end{equation}
                    Then $f$ is surjective. For $\vector{0}\mapsto\vector{0}$,
                    and if $\vector{y}\in\nspace[2]\setminus\{\vector{0}\}$
                ...
                \begin{proof}
                    For $\nsphere[2]\setminus\{(0,0,1)\}$ is homeomorphic to
                    $\nsphere[2]$, and $\nsphere[2]$ is homeomorphic to
                    $\nball[2]$. But homeomorphism is an equivalence relation,
                    and therefore $\nsphere[2]\setminus\{(0,0,1)\}$ is
                    homeomorphic to $\nball[2]$.
                \end{proof}
                It's easier to visual this in one step. This is shown in
                ...
                functions
                $f:\nsphere[1]\rightarrow\nball[2]$. With this we now state, but
                do not prove, the Jordan Curve Theorem.
                ...
                \begin{proof}
                    ...
                    But $S^{2}\setminus\{\vector{s}\}$ is homeomorphic to
    ...
    \subsection{Homotopy Equivalence}
        ...
        \end{theorem}
        \begin{theorem}
            If $f:X\rightarrow\mathbb{R}^{n}$ is continuous, then $f$ is null
            homotopic.
        \end{theorem}
        \begin{proof}
