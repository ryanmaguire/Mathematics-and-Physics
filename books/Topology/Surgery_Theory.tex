        ...
        \subsection{Homotopy}
            ...
            \begin{lexample}
                ...
                \begin{equation}
                    ...
                    H(x,t)=(1-t)f(x)+tg(x)
                \end{equation}
                Then $H(x,0)=f(x)$, $H(x,1)=g(x)$, and $H$ is continuous.
                Thus, ${f}\simeq{g}$. Note that $g(x)=constant$ is possible.
            ...
            \begin{figure}[H]
                ...
                \begin{subfigure}[b]{0.49\textwidth}
                    ...
                    \subcaption{Straight-Line Homotopy.}
                    \label{fig:surgery_theory_course_homotopy_diagram_%
            ...
            \begin{figure}[H]
                \captionsetup{type=figure}
                \centering
                \resizebox{\textwidth}{!}{\subimport{../../tikz/}{Stereographic_Projection}}
            ...
            \begin{proof}
                ...
                such that $g$ is a homeomorphism. But then $\Gamma=g\circ{f}$ is a Jordan Curve.
                By the Jordan Curve Theorem there are two disjoint open connected
                sets $\Int(\Gamma)$ and $\Ext(\Gamma)$ such that
                ...
                \begin{subequations}
                    ...
                    \begin{minipage}[b]{0.49\textwidth}
                        \begin{equation}
                            \mathcal{U}_{2}=g^{-1}\big(\Ext(\Gamma)\big)\cup\{\mathbf{y}\}
                        \end{equation}
                    \end{minipage}
                \end{subequations}
                \par\hfill\par
            ...
            \end{ltheorem}
            \begin{proof}
                The Torus is the Cartesian product of two circles, $T^{1}=S^{1}\times{S}^{1}$,
                and by removing the inner circle we are left with a connected set. Suppose
                the two are homeomorphic and let $f:T^{1}\rightarrow{S}^{2}$ be a homeomorphism.
                Then the restriction of $f$ to $T^{1}\setminus{S}^{1}$ is a homeomorphism
            ...
            \begin{figure}[H]
                \centering
                \captionsetup{type=figure}
                \resizebox{\textwidth}{!}{\subimport{../../tikz/}
            ...
            \begin{enumerate}
                \begin{multicols}{2}
                    \item Is $\mathcal{S}(Y)$ a group?
                    \begin{itemize}
                        \item Sometimes.
                    \end{itemize}
                    \item Is $\mathcal{S}(Y)$ finite?
                    \begin{itemize}
                        \item Sometimes.
                        \begin{itemize}
                            \item $|\mathcal{S}(S^{n})|=1$
                            \item $|\mathcal{S}(T^{n})|=2^{n}$
                        \end{itemize}
                    \end{itemize}
                    ...
                    \begin{itemize}
                        \item Yes.
                        \begin{itemize}
                            \item $|\mathcal{S}(\mathbb{RP}^{5})|$ - Finite.
                            \item $|\mathcal{S}(\mathbb{RP}^{6})|$ - Finite.
                            \item $|\mathcal{S}(\mathbb{RP}^{7})|$ -
                                  \underline{Infinite}.
                            \item $|\mathcal{S}(\mathbb{RP}^{8})|$ - Finite.
                        \end{itemize}
                    \end{itemize}
                \end{multicols}
            \end{enumerate}
            ...
            \begin{ltheorem}{Homeomorphisms Preserve the Fundamental Group}
                If $X$ and $Y$ are homeomorphic,
                then $\pi_{1}(X)$ is isomorphic to $\pi_{1}(Y)$.
            \end{ltheorem}
            \begin{proof}
    ...
    \subsection{Lecture 2: Surgery Structure Sets}
        ...
        \subsubsection{Orientable and Non-Orientable}
            ...
            \begin{figure}[H]
                ...
                \captionsetup{type=figure}
                \resizebox{\textwidth}{!}
                    {\subimport{../../tikz/}{Simple_Surgery_on_Sphere}}
