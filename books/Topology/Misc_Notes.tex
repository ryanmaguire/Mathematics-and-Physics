...
\begin{document}
    ...
    \section{Algebraic Topology Notes}
        ...
        concept is very pictorial, so there will be plenty of figures. We now
        define what it means for continuous functions $f$ and $g$ from a
        ...
        \begin{example}
            ...
            is a homotopy from $f$ to $g$. It is too demanding to ask one to
            only consider convex spaces, but any topological space that is
            homeomorphic to a convex subset of $\nspace$ can inherit this
            homotopy by using function composition with the hypothesized
            homeomorphism. A more general notion is that the space be
            \textit{contractible}, spaces that can be shrunk down continuous to
            a single point.
        \end{example}
