...
\section{Representing Knots}
    ...
    \subsection{Tait Graphs}
        ...
        \end{figure}
        \par\hfill\par
        Tait graphs for equivalent knot diagrams should be equivalent, and thus
        ...
        \par\hfill\par
        Type I tells us we may remove loops. A loop in the Tait graph
        ...
        a leaf we may delete both the vertex and the sole edge that fall upon
        ...
        $\textrm{Y}-\Delta$ transform, a technique famous in circuit theory
