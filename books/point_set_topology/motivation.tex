...
\chapter{Motivation}
    ...
    \index{Euler, Leonhard}\index{Seven Bridges of K\"{o}nigsberg}%
    ...
    a \textit{graph}\index{Graph}, which is a collection of dots called
    ...
    \index{Euler Characteristic}. Consider aEmma Cannon
    ...
    \index{Euler's Polyhedral Formula}. Letting $V$ be the
    ...
    \index{Euler Characteristic}. The
    ...
    \end{equation}
    where $w$ is the \textit{winding number}\index{Winding Number},
    ...
    Bernhard Riemann (1826 - 1866 C.E.)\index{Riemann, Bernhard} and
    ...
    Albert Einstein (1879 - 1955 C.E.)\index{Einstein, Albert}
