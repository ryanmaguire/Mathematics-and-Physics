\section{The Structure of Sets}
    ...
    \subsection{Operations on Sets}
        ...
        \begin{figure}[H]
            \centering
            \captionsetup{type=figure}
            \input{tikz/Venn_Diagram_Distributive_Law_of_Intersections.tex}
        ...
        \begin{proof}
            ...
            (Thm.~\ref{thm:Transitivity_of_Inclusion}).
        \end{proof}
        We can use Venn diagrams to see this clearly (see
        Fig.~\ref{fig:Venn_Diagram_Compare_Dist_Laws_Unions_Intersections}).
        \begin{figure}[H]
            \centering
            \captionsetup{type=figure}
            \input{tikz/Venn_Diagram_Compare_Dist_Laws_Unions_Intersections.tex}
            \caption{Figure for
                     Thm.~\ref{thm:Dist_Law_Inter_Subset_of_Dist_Law_Union}}
            \label{fig:Venn_Diagram_Compare_Dist_Laws_Unions_Intersections}
        \end{figure}
        We now introduce a new set operations called
        \textit{set difference}\index{Set!Difference}.
        \begin{theorem}
