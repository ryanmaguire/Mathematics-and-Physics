\section{The Structure of Sets}
    ...
    \subsection{Operations on Sets}
        ...
        \end{proof}
        We will use this to prove the distribute law of unions.
        ...
        \begin{bproof}
            ...
            (Thm.~\ref{thm:First_Pseudo_Dist_Law_Union}). But
            $A\subseteq{A}\cup{B}$ and $A\subseteq{A}\cup{C}$
            (Thm.~\ref{thm:Union_is_Bigger_Left}) and so
            $A\subseteq(A\cup{B})\cap(A\cup{C})$
            (Thm.~\ref{thm:Intersection_of_Supersets_is_Still_Superset}). Thus:
            \begin{align}
                A\cup(B\cap{C})
                &\subseteq\big((A\cup{B})\cap(A\cup{C})\big)
                    \cup\big((A\cup{B})\cap(A\cup{C})\big)
                \tag{Thm.~\ref{thm:A_cup_B_Subset_C_cup_D}}\\
                &=\big((A\cup{B})\cap(A\cup{C})\big)
                \tag{Thm.~\ref{thm:Idempotent_Law_of_Unions}}
            \end{align}
            And therefore $A\cup(B\cap{C})\subseteq(A\cup{B})\cap(A\cup{C})$
            (Thm.~\ref{thm:Subsets_of_Equal_Sets}).
            \begin{equation}
                A\cup(B\cap{C})\subseteq
                A\cup\Big((A\cup{B})\cap(A\cup{C})\Big)
            \end{equation}
            But $A\cup((A\cup{B})\cap(A\cup{C}))=(A\cup{B})\cap(A\cup{C})$,
            and therefore:
            \begin{equation}
                A\cup(B\cap{C})\subseteq
                (A\cup{B})\cap(A\cup{C})
        ...
        \begin{figure}[H]
            \centering
            \captionsetup{type=figure}
            \input{tikz/Venn_Diagram_Distributive_Law_Intersections.tex}
