...
\section{The Axioms of Zermelo and Fraenkel}
    ...
    \subsection{The Axiom of the Power Set}
        ...
        \begin{example}
            ...
            element subset of $A$ is the entire of $A$! To compute the size of
            ...
            sum. Thus $\sum_{n=1}^{3}n$ is a short way of writing $1+2+3$.
    ...
    \subsection{Cartesian Products and Functions}
        ...
        \textit{graph} is used. We will try to be clear in are useage of this
