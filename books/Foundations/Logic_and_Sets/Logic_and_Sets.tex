...
\begingroup
    ...
    \chapter{Propositional Logic}
        ...
        when developing Boolean Algebras\index{Boolean Algebra} in
        Book~\ref{book:Foundations}, and in Book~\ref{book:Topology} we will
        discuss Stone Spaces\index{Stone Space} which are integral to the Stone
        representation theorem\index{Theorem!Stone's Representation}, connecting
        logic, set theory, topology, and measure theory in a remarkable way.
        \input{\PATH/Propositional_Logic/What_is_Logic.tex}
        \input{\PATH/Propositional_Logic/Connectives.tex}
