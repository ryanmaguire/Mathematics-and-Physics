...
\section{The Axioms of Zermelo and Fraenkel}
    ...
    \subsection{Subsets and Equality}
        ...
        \begin{figure}[H]
            \centering
            \input{tikz/set_theory/Blobs_Subset_Example_001.tex}
    ...
    \subsection{Ordered Pairs and Unions}
        ...
        \begin{figure}[H]
            ...
            \input{tikz/set_theory/Venn_Diagram_Union.tex}
        ...
        \begin{figure}[H]
            \centering
            \captionsetup{type=figure}
            \input{tikz/set_theory/Venn_Diagram_Union_Three_Sets.tex}
        ...
        \begin{figure}[H]
            \centering
            \captionsetup{type=figure}
            \input{tikz/set_theory/Venn_Diagram_Intersection.tex}
        ...
        \begin{figure}[H]
            \centering
            \input{tikz/set_theory/Venn_Diagram_Intersection_of_Three_Sets.tex}
    ...
    \subsection{Cartesian Products and Functions}
        ...
        \begin{figure}[H]
            \centering
            \input{tikz/set_theory/Cartesian_Product_001.tex}
        ...
        \begin{figure}[H]
            \centering
            \input{tikz/set_theory/Cartesian_Product_002.tex}
        ...
        \begin{figure}[H]
            \centering
            \input{tikz/set_theory/Cartesian_Product_003.tex}
        ...
        \begin{figure}[H]
            \centering
            \input{tikz/set_theory/Function_Example_001.tex}
        ...
        \begin{figure}[H]
            \centering
            \input{tikz/set_theory/Non_Function_Example_001.tex}
        ...
        \begin{figure}[H]
            ...
            \begin{subfigure}[b]{0.49\textwidth}
                \centering
                \resizebox{\textwidth}{!}{%
                    \input{tikz/set_theory/Function_Example_002.tex}
                }
            ...
            \begin{subfigure}[b]{0.49\textwidth}
                \centering
                \resizebox{\textwidth}{!}{%
                    \input{tikz/set_theory/Function_Example_003.tex}
                }
        ...
        \begin{figure}[H]
            ...
            \begin{subfigure}[b]{0.49\textwidth}
                \centering
                \resizebox{\textwidth}{!}{%
                    \input{tikz/set_theory/Non_Function_Example_002.tex}
                }
            ...
            \begin{subfigure}[b]{0.49\textwidth}
                \centering
                \resizebox{\textwidth}{!}{%
                    \input{tikz/set_theory/Non_Function_Example_003.tex}
                }
        ...
        \begin{figure}[H]
            \centering
            \captionsetup{type=figure}
            \input{tikz/set_theory/Function_Image_of_Point_and_Subset.tex}
        ...
        \begin{figure}[H]
            \centering
            \captionsetup{type=figure}
            \input{tikz/set_theory/Perpsective_Lines_001.tex}
